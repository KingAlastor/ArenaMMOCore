...
namespace GameServer.GameEngine
{
  ...
  public sealed class ServerRuntimeConfig
  {
    private static readonly JsonSerializerOptions JsonOptions = new()
    {
      ...
      TypeInfoResolver = ServerRuntimeConfigJsonContext.Default
    };
  ...
  [JsonSerializable(typeof(ServerRuntimeConfig))]
  internal sealed partial class ServerRuntimeConfigJsonContext : JsonSerializerContext
  {
  }
}